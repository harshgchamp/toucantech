...
var KTBootstrapDatetimepicker = function () {
    ...
    var baseDemos = function () {
        ...
        // Demo 7
        $('#kt_datetimepicker_7_1').datetimepicker({format: 'DD-MM-YYYY'});
	...
	// date time picker start
        $('#kt_datetimepicker_7_3').datetimepicker({format: 'DD-MM-YYYY H:mm',minDate: new Date() });
        
        $('#kt_datetimepicker_7_4').datetimepicker({
            useCurrent: false,format: 'DD-MM-YYYY H:mm'
        });
	...
	// date time picker start
	$('#kt_datetimepicker_7_5').datetimepicker({format: 'DD-MM-YYYY H:mm'  });
